...
function Contact() {
  ...
  const handleSubmit = (e) => {
    ...
    return (
      <>       
    <div className="my-8">
      <div className='bg-gradient-to-b from-purple-200 to-blue-600 mx-8 text-4xl p-2 flex justify-center font-bold border-2 border-black rounded-lg'>CONTACT US</div>
        <div className='flex flex-wrap justify-around bg-gradient-to-b from-purple-200 to-blue-600 mx-8 mb-5 border-2 border-black rounded-lg'>
                ...
                <div className='pt-5 text-xl flex pb-10 px-4'>
      <Box sx={{display: "flex",flexDirection: "column",alignItems: "center",maxWidth: 600,mx: "auto", p: 2,border: "2px solid  #000000",borderRadius: "12px",boxShadow: 1, }}>
